...
Premièrement, j'ai programmé une calculette en python tout seul sans aucune aide uniquement ma logique et je l'ai fais sur mon Raspberry pi 5 et vous pouvez observer la façon dont je me suis pris pour faire ce bot calculateur et voir ma logique. j'ai fais la même chose en java mais sans utilisé la POO car je n'avais pas encore appris quand j'ai commencé à la faire et en java j'ai appris pour le moment les conditions, les variables, les opérateur, les &&, ||, !=, % etc, et pour finir les méthodes ou j'ai aussi fais un exercice dessus.

J'ai aussi pratiqué Unity un moteur de jeu polyvalent pendant 6 semaines j'arrive tout seul à bien gérer l'interface graphique de Unity (gestion de la physique, des Sprites, des collisions, tilemaps, animation) et aussi quelque script simples notamment la création de tableau avec [Header("")] qui nous permet de glisser des gameObjects, des Materials, des frames d'animation etc... et aussi un bout de la barre de vie et plein d'autre petit truc de ce style.
